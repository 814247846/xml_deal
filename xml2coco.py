...
def main():
    xml_path = './data/aug_underwater/train/box' #xml
    print('xml_path: ', xml_path)
    # xml_path = '../../../Datasets/underwater/data0/18test/label'
    img_path = './data/aug_underwater/train/image' #img
    # img_path = '../../../Datasets/underwater/data0/18test/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, './data/aug_underwater/annotations/train_aug.json')  # json
